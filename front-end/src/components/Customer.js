    ...
    return (
        <div className='Customers'>
            <div className='Header'>
                <div className='Name'><img src='https://cdn-user-icons.flaticon.com/96885/96885753/1679413474378.svg?token=exp=1679414375~hmac=6711997f218f020aa8895c37fe44ec4b' width='30' alt='' style={{ marginRight: "1rem" }} />SDE sheets</div>
                <div className='Customer'>
                    <div className='Add-Customer-Button' onClick={() => document.documentElement.style.setProperty('--displayAddC', 'flex')}>Add Sheet<img src='https://cdn-icons-png.flaticon.com/512/1828/1828925.png' width="15" alt='' style={{ marginLeft: "10px", filter: "invert(100%)" }} /></div>
                </div>
            </div>
            <form className="Add-Customer" onSubmit={AddCustomer}>
                <input type="text" className="form-control" placeholder='Enter the link' onChange={(e) => setCustomer(e.target.value)} required />
                <input type="tel" className="form-control" placeholder='Enter the name of the author' onChange={(e) => setContact(e.target.value)} required />
            ...
            <form className="Update-Customer" onSubmit={UpdateCustomer}>
                <input type="text" className="form-control" placeholder='Enter the link' defaultValue={`${update1}`} onChange={(e) => setCustomer(e.target.value)} required />
                <input type="tel" className="form-control" placeholder='Enter the name of the manager' defaultValue={`${update2}`} onChange={(e) => setContact(e.target.value)} required />
            ...
            <div className='Customers-heading'>
                <div>No.</div>
                <div style={{ textAlign: "start" }}>SDE sheet</div>
                <div>Author</div>
                <div>Actions</div>
            </div>
