    ...
    return (
      <div className='Products'>
        <div className='Header'>
          <div className='Name'><img src='https://cdn-user-icons.flaticon.com/96885/96885753/1679321351604.svg?token=exp=1679322252~hmac=60974dc39c6b4c238b4bf00fed2fac31' width='25' alt='' style={{marginRight: "1rem"}}/>Problems</div>
          <div className='Add-Filter'>
            ...
            {/* <Link to='/AddProduct' className='Add-item' style={{backgroundColor: "#017256", color: "white"}}>Add Problems<img src='https://cdn-icons-png.flaticon.com/512/1828/1828925.png' width="15" alt='' style={{marginLeft:"10px", filter: "invert(100%)"}}/></Link> */}
          </div>
        </div>
        <div className='list-heading'>
          <div>No.</div>
          <div style={{textAlign: "start"}}>Problem name</div>
          <div>Tags</div>
          <div>Difficulty Level</div>
          <div>Actions</div>
          {/* <div>Solved or Not</div> */}
          {/* <div>Unknown</div> */}
          {/* <div>Actions</div> */}
        </div>
        <div className="list">
