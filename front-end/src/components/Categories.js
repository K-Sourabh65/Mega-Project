    ...
    return (
      <div className='Categories'>
        <div className='Header'>
          <div className='Name'><img src='https://cdn-user-icons.flaticon.com/96885/96885753/1679413474378.svg?token=exp=1679414375~hmac=6711997f218f020aa8895c37fe44ec4b' width='30' alt='' style={{marginRight: "1rem"}}/>Articles</div>
          <div className='Category'>
            <div className='Add-Category-Button' onClick={() => document.documentElement.style.setProperty('--displayAdd', 'flex')}>Add Article<img src='https://cdn-icons-png.flaticon.com/512/1828/1828925.png' width="15" alt='' style={{marginLeft:"10px", filter: "invert(100%)"}}/></div>
          </div>
        </div>
        ...
        <div className='Categories-heading'>
          <div>No.</div>
          <div style={{textAlign: "start"}}>Articles</div>
          <div>Publisher</div>
